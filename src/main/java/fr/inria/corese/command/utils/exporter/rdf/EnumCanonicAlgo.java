...
public enum EnumCanonicAlgo {
    ...
    // Rdfc-1.0-sha256
    RDFC_1_0("rdfc-1.0", ResultFormatDef.format.RDFC10_FORMAT, "nq"),
    RDFC_1_0_SHA256("rdfc-1.0-sha256", ResultFormatDef.format.RDFC10_FORMAT, "nq"),

    // Rdfc-1.0-sha384
    RDFC_1_0_SHA384("rdfc-1.0-sha384", ResultFormatDef.format.RDFC10_SHA384_FORMAT, "nq");
